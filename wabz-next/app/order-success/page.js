    ...
    <div className="max-w-md mx-auto px-5 py-24 text-center">
      ...
      {state === "pending" && (
        <>
          ...
          <Link href="/orders" className="inline-block mt-8 text-persimmon underline">View my orders</Link>
        </>
      )}
      {state === "error" && (
        <>
          ...
          <Link href="/" className="inline-block mt-8 text-persimmon underline">Back to menu</Link>
        </>
      )}
    </div>
  );
