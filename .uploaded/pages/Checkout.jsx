...
export default function Checkout() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      // Stripe Checkout must run in a top-level window, not inside the preview iframe.
  ...
  return (
    <div className="max-w-5xl mx-auto px-5 md:px-8 py-12">
      <Link to="/" className="inline-flex items-center gap-2 text-sm text-carbon/60 hover:text-persimmon mb-6">
